            ...
            child: Column(
              ...
              children: [
                ...
                _LoginButton(
                  ...
                  label: 'Ingresar como Solicitante',
                  color: GloboColors.success,
                  onTap: () => ref.read(demoUserProvider.notifier).state = solicitanteDemo,
                ),
                const SizedBox(height: GloboSpacing.md),
                _LoginButton(
                  icon: Icons.assignment_outlined,
                  label: 'Ingresar como Despachador',
                  color: GloboColors.info,
                  onTap: () => ref.read(demoUserProvider.notifier).state = despachadorDemo,
                ),
                const SizedBox(height: GloboSpacing.md),
                _LoginButton(
                  icon: Icons.build_outlined,
                  label: 'Ingresar como Mantenimiento',
                  color: GloboColors.warning,
                  onTap: () => ref.read(demoUserProvider.notifier).state = mantenimientoDemo,
                ),
                const SizedBox(height: GloboSpacing.md),
                _LoginButton(
                  icon: Icons.insights_outlined,
                  label: 'Ingresar como Dirección',
                  color: GloboColors.primaryAccent,
                  onTap: () => ref.read(demoUserProvider.notifier).state = direccionDemo,
                ),
